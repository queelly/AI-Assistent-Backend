        ...
        if serializer.is_valid():
            ...
            if (category == "Помещения и Сооружения"):
                request_json = {
                    ...
                    "history": [
                        {"role": "system",
                         "content": "Ты - полезный ассистент в области инвестиций. Если человек задает вопрос не по делу, отвечай <<Это не моя компетенция>>. Тебе дан список категорий  и дано сообщение пользователя. Если человек имеет ввиду категорию которая есть в списке категорий, то ответь только этой категорией,если в сообщении пользователя категорий несколько, то напиши несколько категорий о которых вел речь пользователь.Если ни к одной категории не относится,  то напиши <<Извините я не понимаю о чем вы>>. Сам список категорий: Муниципальное образование, Тип площадки, Форма собственности объекта,Стоимость объекта ,Стоимость руб./год за га, Стоимость, руб./год за га,min и max сроки аренды ,Свободная площадь ЗУ га, Варианты разрешенного использования, Свободная площадь, Водоснабжение Наличие,Водоотведение Наличие,Газоснабжение Наличие,Электроснабжение Наличие,Теплоснабжение Наличие,Вывоз ТКО Наличие,Наличие подъездных путей,Наличие ж/д,Наличие парковки грузового транспорта "},
                    ]
                }
            response = requests.post(url='https://ask.chadgpt.ru/api/public/gpt-3.5', json=request_json)
            if response.status_code == 200:
